      ...
      <div className="home-container">
        ...
        {error && (
          <div className="error-state">
            <p><i className="fas fa-exclamation-triangle" style={{ marginRight: "8px", color: "var(--danger)" }}></i> {error}</p>
          ...
          <>
            {items.length === 0 ? (
              <div className="empty-state">
                <p><i className="fas fa-search" style={{ marginRight: "8px" }}></i> No products match your filters</p>
              </div>
            ) : (
